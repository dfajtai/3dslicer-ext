...
1. "Section" dataclasses (StudyConfig, SegmentationConfig, LandmarksConfig,
   VolumeRenderingConfig, GlobalWindowLevelConfig, BatchExportConfig,
...
class StudyConfig:
    ...
    volume_rendering: VolumeRenderingConfig = field(default_factory=VolumeRenderingConfig)
    ...
    def from_dict(cls, raw: Optional[dict], base_dir: str = "."):
        ...
        return cls(
            ...
            volume_rendering=VolumeRenderingConfig.from_dict(raw.get("volume_rendering")),
